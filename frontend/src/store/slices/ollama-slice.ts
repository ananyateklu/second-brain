/**
 * Ollama Download Slice
 * Manages Ollama model download state
 */

import { aiService } from '../../services/ai.service';
import type { OllamaPullProgress, OllamaPullRequest } from '../../types/ai';
import type { OllamaSlice, SliceCreator, ModelDownload } from '../types';

export const createOllamaSlice: SliceCreator<OllamaSlice> = (set, get) => ({
  downloads: {},
