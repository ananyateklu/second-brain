...
const typeConfig = {
  success: {
    ...
    progressColorClass: 'bg-[var(--color-brand-500)]/50',
  },
  error: {
    icon: <ErrorIcon />,
    containerClass: 'border-[var(--border)]',
    ...
    progressColorClass: 'bg-[var(--color-error)]/50',
  },
  warning: {
    icon: <WarningIcon />,
    containerClass: 'border-[var(--border)]',
    ...
    progressColorClass: 'bg-amber-500/50',
  },
  info: {
    icon: <InfoIcon />,
    containerClass: 'border-[var(--border)]',
    ...
    progressColorClass: 'bg-[var(--color-accent-blue)]/50',
  },
  loading: {
    icon: <LoadingIcon />,
    containerClass: 'border-[var(--border)]',
