...
export const GitHubBranchSelector = () => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div
          className="absolute top-full left-0 mt-2 w-72 rounded-xl border shadow-lg z-50 overflow-hidden backdrop-blur-xl"
          style={{
                ...
                {filteredBranches.map((branch) => {
                  ...
                  return (
                    <button
                      ...
                      className="w-full text-left px-3 py-2 rounded-lg text-sm transition-colors flex items-center gap-2 hover:bg-[color-mix(in_srgb,var(--text-primary)_3%,transparent)]"
                      style={{
