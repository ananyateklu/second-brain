...
export function TaskCard({ task }: TaskCardProps) {
  ...
  return (
    <>
      <div className="group bg-white dark:bg-dark-card rounded-xl p-4 hover:shadow-md dark:hover:shadow-lg dark:hover:shadow-black/10 transition-all duration-200">
