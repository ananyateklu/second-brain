...
export function TaskCard({ task, viewMode }: TaskCardProps) {
  ...
  const ListViewCard = () => (
    <div className="group bg-white dark:bg-dark-card rounded-lg p-3 hover:shadow-md dark:hover:shadow-lg dark:hover:shadow-black/10 transition-all duration-200 border border-gray-200 dark:border-gray-700">
  ...
  const GridViewCard = () => (
    <div className="group bg-white dark:bg-dark-card rounded-xl p-4 hover:shadow-md dark:hover:shadow-lg dark:hover:shadow-black/10 transition-all duration-200 border border-gray-200 dark:border-gray-700">
