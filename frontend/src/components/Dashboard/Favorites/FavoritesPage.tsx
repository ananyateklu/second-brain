  ...
  return (
    <div className="h-[calc(100vh-144px)]">
      <div className="h-full flex flex-col space-y-3">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-between">
              <div className="flex items-center gap-3">
                <div className="p-2.5 bg-[var(--color-idea)]/10 rounded-lg">
                  <Star className="w-6 h-6 text-[var(--color-idea)]" />
                </div>
                <div>
        ...
        {/* Main Content Area */}
        <div className="flex-1 bg-[var(--color-surface)] border border-[var(--color-border)] shadow-sm rounded-xl p-4 min-h-0 overflow-y-auto">
          {favoriteNotes.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center h-full text-center py-12">
              <Star className="w-12 h-12 text-[var(--color-textSecondary)] mb-4" />
