  ...
  return (
    <div className="h-[calc(100vh-144px)]">
      <div className="h-full flex flex-col space-y-3">
        ...
        {/* Main Content Area */}
        <div className="flex-1 bg-white/20 dark:bg-gray-800/20 border border-gray-200/30 dark:border-gray-700/30 shadow-sm rounded-xl p-4 min-h-0 overflow-y-auto">
          {favoriteNotes.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center h-full text-center py-12">
              <Star className="w-12 h-12 text-gray-400 dark:text-gray-600 mb-4" />
