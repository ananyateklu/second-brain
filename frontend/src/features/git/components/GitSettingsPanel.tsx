...
export const GitSettingsPanel = memo(function GitSettingsPanel({
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Dialog */}
      <div
        className="relative w-full max-w-lg rounded-2xl overflow-hidden backdrop-blur-xl bg-[var(--glass-bg)] transform-gpu animate-in fade-in zoom-in-95 slide-in-from-bottom-4 duration-300"
        style={{
      ...
      >
        ...
        >
          <button
            ...
            className="px-4 py-2.5 text-sm font-medium rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed hover:enabled:bg-[var(--color-error-light)]"
            style={{
