...
export const GitHubPullRequestList = ({
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Filter Tabs - Fixed at top, responsive */}
      <div className="flex-shrink-0 flex flex-wrap items-center gap-1.5 sm:gap-2 mb-4">
        {(['open', 'closed', 'all'] as PullRequestFilter[]).map((filter) => (
          <button
            ...
            className={`px-2.5 sm:px-4 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm font-medium transform-gpu transition-all duration-200 ${stateFilter === filter
