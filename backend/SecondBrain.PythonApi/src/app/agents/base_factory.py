...
class BaseAgentFactory:
    """Factory class for creating base AI agents"""
    ...
    @classmethod
    def create_base_agent(cls, model_id: str, temperature: float = 0.7) -> BaseAgent:
        """Create a base agent instance based on the model ID"""
