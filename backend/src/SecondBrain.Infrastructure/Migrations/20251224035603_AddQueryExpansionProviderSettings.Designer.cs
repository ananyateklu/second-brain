...
namespace SecondBrain.Infrastructure.Migrations
{
    ...
    [Migration("20251224035603_AddQueryExpansionProviderSettings")]
    partial class AddQueryExpansionProviderSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SecondBrain.Core.Entities.ChatSession", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
                    ...
                    b.Property<NpgsqlRange<DateTime>>("SessionPeriod")
                        .HasColumnType("tstzrange")
                        .HasColumnName("session_period");
            ...
            modelBuilder.Entity("SecondBrain.Core.Entities.NoteEmbedding", b =>
                {
                    ...
                    b.HasIndex("EmbeddingDimensions")
                        .HasDatabaseName("idx_note_embeddings_dimensions");
                    ...
                    b.HasIndex("UserId", "EmbeddingDimensions")
                        .HasDatabaseName("idx_note_embeddings_user_dimensions");
            ...
            modelBuilder.Entity("SecondBrain.Core.Entities.NoteVersion", b =>
                {
                    ...
                    b.Property<NpgsqlRange<DateTime>>("ValidPeriod")
                        .HasColumnType("tstzrange")
                    ...
                    b.HasIndex("ModifiedBy")
                        .HasDatabaseName("ix_note_versions_modified_by");
            ...
            modelBuilder.Entity("SecondBrain.Core.Entities.UserPreferences", b =>
                {
                    ...
                    b.Property<float>("RagBm25Weight")
                        .HasColumnType("real")
                        .HasColumnName("rag_bm25_weight");

                    b.Property<int?>("RagEmbeddingDimensions")
                        .HasColumnType("integer")
                        .HasColumnName("rag_embedding_dimensions");

                    b.Property<string>("RagEmbeddingModel")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("rag_embedding_model");

                    b.Property<string>("RagEmbeddingProvider")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("rag_embedding_provider");
                    ...
                    b.Property<string>("RagHydeModel")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("rag_hyde_model");

                    b.Property<string>("RagHydeProvider")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("rag_hyde_provider");

                    b.Property<int>("RagInitialRetrievalCount")
                        .HasColumnType("integer")
                        .HasColumnName("rag_initial_retrieval_count");

                    b.Property<int>("RagMaxContextLength")
                        .HasColumnType("integer")
                        .HasColumnName("rag_max_context_length");

                    b.Property<float>("RagMinRerankScore")
                        .HasColumnType("real")
                        .HasColumnName("rag_min_rerank_score");

                    b.Property<int>("RagMultiQueryCount")
                        .HasColumnType("integer")
                        .HasColumnName("rag_multi_query_count");

                    b.Property<string>("RagQueryExpansionModel")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("rag_query_expansion_model");

                    b.Property<string>("RagQueryExpansionProvider")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("rag_query_expansion_provider");
                    ...
                    b.Property<float>("RagSimilarityThreshold")
                        .HasColumnType("real")
                        .HasColumnName("rag_similarity_threshold");

                    b.Property<int>("RagTopK")
                        .HasColumnType("integer")
                        .HasColumnName("rag_top_k");

                    b.Property<float>("RagVectorWeight")
                        .HasColumnType("real")
                        .HasColumnName("rag_vector_weight");
