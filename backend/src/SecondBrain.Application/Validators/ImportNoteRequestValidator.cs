...
/// <summary>
/// Validator for ImportNoteRequest
/// </summary>
public class ImportNoteRequestValidator : AbstractValidator<ImportNoteRequest>
{
    public ImportNoteRequestValidator()
    {
        RuleFor(x => x.Title)
            .NotEmpty()
        ...
        RuleFor(x => x.ExternalId)
            ...
            .WithMessage("External ID must not exceed 200 characters");
    }
}
