...
{
    private readonly UpdateNoteRequestValidator _sut;

    public UpdateNoteRequestValidatorTests()
    {
        _sut = new UpdateNoteRequestValidator();
    }
    ...
    {
        // Arrange
        var request = new UpdateNoteRequest { Title = "" };
    ...
    {
        // Arrange
        var request = new UpdateNoteRequest { Title = new string('a', 501) };
    ...
    private static UpdateNoteRequest CreateValidRequest()
    {
